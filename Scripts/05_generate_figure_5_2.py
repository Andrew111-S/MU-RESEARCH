...
zoom = (df["mV_GeV"] >= 55.0) & (df["mV_GeV"] <= 62.45)
zoom_band = (bands["mV_GeV"] >= 55.0) & (bands["mV_GeV"] <= 62.45)
...
plt.fill_between(
    ...
    alpha=0.18,
    label=r"ATLAS 2022 VBF expected sensitivity $\pm2\sigma$"
)
...
plt.fill_between(
    ...
    alpha=0.30,
    label=r"ATLAS 2022 VBF expected sensitivity $\pm1\sigma$"
)
